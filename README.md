...
Interactive plots, filterable tables, [platform rankings](https://francoismarieleregent.xyz/awesome-quantum-computing-experiments/rankings) (spider charts, replayable by year) and [research groups](https://francoismarieleregent.xyz/awesome-quantum-computing-experiments/groups) live on the **[website](https://francoismarieleregent.xyz/awesome-quantum-computing-experiments)**. This README is generated from the same data by `make readme`.
...
| [![Top research groups](out/png/top_research_groups.png)](https://francoismarieleregent.xyz/awesome-quantum-computing-experiments/#top-research-groups)<br>**Top research groups** ([interactive](https://francoismarieleregent.xyz/awesome-quantum-computing-experiments/#top-research-groups)) | [![Platform rankings per metric (spider charts)](out/png/rankings_radar.png)](https://francoismarieleregent.xyz/awesome-quantum-computing-experiments/rankings)<br>**Platform rankings per metric (spider charts)** ([interactive](https://francoismarieleregent.xyz/awesome-quantum-computing-experiments/rankings)) |
| [![Q-day estimates: trends vs published requirements](out/png/qday_summary.png)](https://francoismarieleregent.xyz/awesome-quantum-computing-experiments/qday)<br>**Q-day estimates: trends vs published requirements** ([interactive](https://francoismarieleregent.xyz/awesome-quantum-computing-experiments/qday)) | [![Neutral atoms: qubit count vs Shor requirements](out/png/qday_qubits_neutral_atoms.png)](https://francoismarieleregent.xyz/awesome-quantum-computing-experiments/qday)<br>**Neutral atoms: qubit count vs Shor requirements** ([interactive](https://francoismarieleregent.xyz/awesome-quantum-computing-experiments/qday)) |
| [![Superconducting circuits: qubit count vs Shor requirements](out/png/qday_qubits_superconducting_circuits.png)](https://francoismarieleregent.xyz/awesome-quantum-computing-experiments/qday)<br>**Superconducting circuits: qubit count vs Shor requirements** ([interactive](https://francoismarieleregent.xyz/awesome-quantum-computing-experiments/qday)) | [![Ion traps: qubit count vs Shor requirements](out/png/qday_qubits_ion_traps.png)](https://francoismarieleregent.xyz/awesome-quantum-computing-experiments/qday)<br>**Ion traps: qubit count vs Shor requirements** ([interactive](https://francoismarieleregent.xyz/awesome-quantum-computing-experiments/qday)) |
...
- [High-fidelity entangling gates and nonlocal circuits with neutral atoms](https://arxiv.org/abs/2604.25987) (2026) - 0.00146 on Neutral atoms, Rb, CZ gate, 99.854(4)% raw / 99.941(3)% loss-postselected, stable >10h
